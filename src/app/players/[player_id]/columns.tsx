...
export const columns: ColumnDef<PlayerScore>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return <div className={clsx(hole_6 < 3 ? "text-red-500  border rounded-full w-6 border-black mx-auto text-center" : hole_6 > 3 ? "text-gray-300 border w-6 border-black mx-auto text-center" : "text-[#9A9540] text-center")}>{hole_6}</div>;
    },
  },
  {
    accessorKey: "hole_7",
