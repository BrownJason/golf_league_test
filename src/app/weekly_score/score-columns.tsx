...
export const scoreColumns: ColumnDef<WeeklyScore>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return <div className={clsx(hole_1 < 4 ? "text-red-500 border rounded-full w-6 border-black mx-auto text-center" : hole_1 > 4 ? "text-gray-300 border w-6 border-black mx-auto text-center" : "text-[#EDE6D6] text-center")}>{hole_1}</div>;
    },
  },
  {
    accessorKey: "hole_2",
    ...
    cell: ({ row }) => {
      ...
      return <div className={clsx(hole_2 < par ? "text-red-500 border rounded-full w-6 border-black mx-auto text-center" : hole_2 > par ? "text-gray-300 border w-6 border-black mx-auto text-center" : "text-[#EDE6D6] text-center")}>{hole_2}</div>;
    },
  },
  {
    accessorKey: "hole_3",
    ...
    cell: ({ row }) => {
      ...
      return <div className={clsx(hole_3 < par ? "text-red-500 border rounded-full w-6 border-black mx-auto text-center" : hole_3 > par ? "text-gray-300 border w-6 border-black mx-auto text-center" : "text-[#EDE6D6] text-center")}>{hole_3}</div>;
    },
  },
  {
    accessorKey: "hole_4",
    ...
    cell: ({ row }) => {
      ...
      return <div className={clsx(hole_4 < 4 ? "text-red-500 border rounded-full w-6 border-black mx-auto text-center" : hole_4 > 4 ? "text-gray-300 border w-6 border-black mx-auto text-center" : "text-[#EDE6D6] text-center")}>{hole_4}</div>;
    },
  },
  {
    accessorKey: "hole_5",
    ...
    cell: ({ row }) => {
      ...
      return <div className={clsx(hole_5 < 4 ? "text-red-500 border rounded-full w-6 border-black mx-auto text-center" : hole_5 > 4 ? "text-gray-300 border w-6 border-black mx-auto text-center" : "text-[#EDE6D6] text-center")}>{hole_5}</div>;
    },
  },
  {
    accessorKey: "hole_6",
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return <div className={clsx(hole_7 < 4 ? "text-red-500  border rounded-full w-6 border-black mx-auto text-center" : hole_7 > 4 ? "text-gray-300 border w-6 border-black mx-auto text-center" : "text-[#EDE6D6] text-center")}>{hole_7}</div>;
    },
  },
  {
    accessorKey: "hole_8",
    ...
    cell: ({ row }) => {
      ...
      return <div className={clsx(hole_8 < 5 ? "text-red-500  border rounded-full w-6 border-black mx-auto text-center" : hole_8 > 5 ? "text-gray-300 border w-6 border-black mx-auto text-center" : "text-[#EDE6D6] text-center")}>{hole_8}</div>;
    },
  },
  {
    accessorKey: "hole_9",
    ...
    cell: ({ row }) => {
      ...
      return <div className={clsx(hole_9 < 4 ? "text-red-500  border rounded-full w-6 border-black mx-auto text-center" : hole_9 > 4 ? "text-gray-300 border w-6 border-black mx-auto text-center " : "text-[#EDE6D6] text-center")}>{hole_9}</div>;
    },
  },
];
